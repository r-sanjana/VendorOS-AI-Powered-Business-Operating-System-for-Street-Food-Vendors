...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role",sa.Enum("ADMIN","VENDOR","EMPLOYEE","CUSTOMER",name="userrole",),nullable=False,),
    ...
    op.create_table(
        ...
        sa.Column("category",sa.Enum("RICE","OIL","CHICKEN","SPICES","VEGETABLES","PACKAGING","BEVERAGES","OTHER",name="inventorycategory",),nullable=False,),
    ...
    op.create_table(
        ...
        sa.Column("movement_type",sa.Enum("IN","OUT","WASTE","ADJUST",name="movementtype",),nullable=False,),
    ...
    op.create_table(
        ...
        sa.Column("payment_method",sa.Enum("CASH","UPI","CARD",name="paymentmethod",),nullable=False,),
    ...
    op.create_table(
        ...
        sa.Column("category",sa.Enum("RAW_MATERIALS","GAS","ELECTRICITY","RENT","TRANSPORTATION","SALARY","MAINTENANCE","MARKETING","OTHER",name="expensecategory",),nullable=False,),
